...
var OfferingFinancialPage = (function (_super) {
    __extends(OfferingFinancialPage, _super);
    function OfferingFinancialPage() {
    ...
    OfferingFinancialPage.prototype.searchOfferingFinancial = function () {
    ...
    OfferingFinancialPage.prototype.componentDidMount = function () {
        return __awaiter(this, void 0, void 0, function* () {
            this.searchOfferingFinancial();
        });
    };
    OfferingFinancialPage.prototype.render = function () {
        var _a = this.state, loading = _a.loading, offeringFinancialItems = _a.offeringFinancialItems, offeringID = _a.offeringID;
					...
					<div className="site-layout-content">
						...
						<antd_1.Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} className={Financial_module_scss_1.default.paddingTop10px}>
							<antd_1.Col className={"gutter-row " + Financial_module_scss_1.default.offeringFinancialDetails} xs={24} sm={24} md={24}>
								<antd_2.Table columns={this.columns} dataSource={offeringFinancialItems} loading={loading} bordered pagination={{ position: ['topLeft'] }}/>
							</antd_1.Col>
						</antd_1.Row>
					</div>
				</Content>
    ...
    return OfferingFinancialPage;
}(React.Component));
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = OfferingFinancialPage;
