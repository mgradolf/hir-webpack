...
import OfferingCreateForm from "~/Component/Offering/Forms/OfferingCreateForm"
...
export const OfferingCreateFormModalOpenButton = (props: { offeringData?: { [key: string]: any } }) => {
