...
import { Form, Input, Select, Switch, DatePicker, Table, Spin, Button, Card, Col, Row } from "antd"
          ...
          <Spin size="large" spinning={loading}>
            <Form form={form} initialValues={props.initialFormValue}>
              ...
              <Form.Item label="Final Enrollment Date" {...layout}>
                <Input
                  disabled
                  value={moment(props.initialFormValue.FinalEnrollmentDate, REQUEST_DATE_TIME_FORMAT).format(
                    DATE_FORMAT
                  )}
                />
              </Form.Item>
